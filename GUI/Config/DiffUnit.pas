...
//{$DEFINE DIFF_BYTES}
  ...
  public
    ...
    {$IFDEF DIFF_BYTES}
    function Execute(const Arr1, Arr2: PByteArray; ArrSize1, ArrSize2: integer): boolean;
    {$ELSE}
...
{$IFDEF DIFF_BYTES}
function TDiff.Execute(const Arr1, Arr2: PByteArray; ArrSize1, ArrSize2: integer): boolean;
{$ELSE}
...
var
  ...
  begin
    ...
    begin
      ...
      else begin PushAdd; NewAdd(x1,y1); end;   //add NOT in series
    end
    ...
    begin
      ...
      begin
        ...
        else begin PushMod; NewMod(x1,y1); end; //start NEW modify

        if fLastDel.Range = 1 then TrashDel     //decrement or remove existing del
        else begin dec(fLastDel.Range); inc(fLastDel.x); end;
      end
      else begin PushDel; NewAdd(x1,y1); end;   //add does NOT match pending del's
    end
    else
  ...
  begin
    ...
    begin
      ...
      else begin PushDel; NewDel(x1); end;      //del NOT in series
    end
    ...
    begin
      ...
      begin
        ...
        else begin PushMod; NewMod(x1,fLastAdd.y); end; //start NEW modify ...
      ...
      else begin PushAdd; NewDel(x1); end;      //del does NOT match pending add's
    end
    else
...
begin
  case ScriptKind of
    ...
    skDelDiagDel:   begin Delete(x1); Delete(x2-1); end;
    skAddDiagAdd:   begin Add(x1,y1); Add(x2,y2-1); end;
    skAddDel:       begin Add(x1,y1); Delete(x2-1); end;
    skDelDiagAdd:   begin Delete(x1); Add(x2,y2-1); end;
    skAddDiagDel:   begin Add(x1,y1); Delete(x2-1); end;
  end;
end;
//--------------------------------------------------------------------------
